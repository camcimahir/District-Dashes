class GameOver extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.bitmapText(centerX, centerY - 128, 'gem_font', 'GAME OVER', 72).setOrigin(0.5)
        this.add.bitmapText(centerX, centerY - 64, 'gem_font', ' right for menu, left for play again', 32).setOrigin(0.5)
